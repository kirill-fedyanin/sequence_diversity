...
class EnsembleGenerator(T5ForConditionalGeneration):
    def add_ensemble_models(self, *models):
        ...
        **model_kwargs,
        ...
        while True:
            ...
            for outputs in models_outputs:
                model_next_token_logits = outputs.logits[:, -1, :]
            ...
            next_token_scores_clone = next_token_scores.clone()
            next_token_scores_processed = logits_processor(input_ids, next_token_scores)
            iter_models_scores = []
            for model_scores in models_next_token_logits:
                iter_models_scores.append(model_scores)
